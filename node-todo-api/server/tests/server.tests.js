...
describe('POST /todos', () => {
  it('should create a new todo', (done) => {
    ...
    console.log('token:',users[0].tokens[0])
...
describe('DELETE /todos/:id', () => {
  ...
  it('should not reomve a todo created by other user', (done) => {
...
describe('PATCH /todos/:id', () => {
  ...
  it('should not update the todo from a different user', (done) => {
    var id = todos[0]._id.toHexString()
    var updatedTodo = {text: "go to bed", completed: true}
